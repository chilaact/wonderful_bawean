   ...
   <?php foreach ($detwis as $detail) : ?>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div style="width: 100%">             
            <table class="table">
              <tr>
                <td style="width: 20em">Nama Wisata</td>
              ...
              <tr>
                ...
                <td style="width: 3em; text-align: center;">:</td>
                <td><strong><?php echo $detail->wis_desc_long?></strong></td>
              </tr>
              <tr>
                <td style="width: 20em">Image</td>
                <td style="width: 3em; text-align: center;">:</td>
                <td><img src="<?php echo base_url().'/assets/image/'.$detail->wis_img ?>" alt="FImageo" class="img-fluid" style="width: 50%"></td>
              </tr>
            </table>
    ...
    <div class="card">
      ...
      <div class="card-body">
                ...
                <?php $no=1; foreach ($detfas as $det) : ?>
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <a href="<?php echo base_url() ?>C_admin/edit_fas/<?php echo $det->fas_id; ?>" class="btn btn-outline-warning">Edit</a>
                      <a href=" <?php echo base_url() ?>C_admin/deletefas/<?php echo $det->fas_id; ?>" class="btn btn-outline-danger">Delete</a>
        ...
        <br>
          <a href="<?php echo base_url('C_admin/wisata'); ?>" class="btn btn-primary right">Kembali</a>
    </div> 
